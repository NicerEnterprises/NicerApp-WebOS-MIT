...
<body onload="siteOnLoad()" style="font-family: 'Roboto Condensed', sans-serif;">
    ...
    <div id="siteTaskbar" class="vividDialog naTaskbar">
      <div class="vividDialogBackground1"></div>
      <video src="https://{$domain}/NicerAppWebOS/siteMedia/videos/output1.webm"
        preload="none"
      ...
      <canvas></canvas>
      <video src="https://{$domain}/NicerAppWebOS/siteMedia/videos/output3.webm"
        preload="none"
...
echo $naWebOS->html_vividButton (
    ...
    <div id="btnOptions_menu" class="vividDialogPopup anchored vividScrollpane" style="z-index:-10;overflow:visible;"
        ...
        //onmouseover="na.site.onmouseover_btnOptions(event);" onmouseout="na.site.onmouseout_btnOptions(event)"
            global $naWebOS;
            $fn = realpath(dirname(__FILE__).'/../../../').'/NicerAppWebOS/domainConfigs/'.$naWebOS->domainFolder.'/btnOptions_menu__default.php';
