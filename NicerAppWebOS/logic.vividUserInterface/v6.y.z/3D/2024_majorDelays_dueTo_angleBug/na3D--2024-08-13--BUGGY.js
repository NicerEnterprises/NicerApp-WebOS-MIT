...
export class na3D_fileBrowser {
    constructor(el, parent, parameters) {
        ...
        */
        ...
        t.cameraControls.enabled = t.useCameraControls;
...
//                debugger;
            ...
            //if (t.cameraOrigin && t.cameraOrigin.x && t.middle && t.middle.x) {
                if (t.middle && t.middle.x) {
                    if (!t.started3) {
                        ...
                        t.cameraControls._camera.position.y = t.middle.y;
                        t.camera.position.y = t.middle.y;
            ...
            if (t.lookClock > 0 && delta2 > t.lookClock) {
                ...
                t.flyControls.enabled = false;
                t.orbitControls.enabled = true;
                t.cameraControlsEnabled = true;
            }
            t.cameraControls.enabled = t.useCameraControls && t.cameraControlsEnabled;


            var threshold = 1;
            var x = t.orbitControls.mouseAction;//t.cameraControls._activePointers;
            console.log ('x', x);
            if (x || x === 0)
                if (x===0 || x===2) {
                    //debugger;
                    ...
                    t.cameraControlsEnabled = true;
                    t.orbitControls.enabled = true;
                    t.cameraControls.enabled =
                        t.useCameraControls && t.cameraControlsEnabled;
                }*/
